...
('aabba4be-51cd-46cb-99cc-17211c62343a', 'pro@test.com', 'analytics_demo', '\$2b\$10\$rGQHFh2Cv7hZZl7Zj7mZWu.VKVzRjZrKxXgO0lz5mJz8QHgxLpZUa', 'Analytics Demo User', 'pro', true, NOW() - INTERVAL '30 days'),
('6c744ef0-c664-454a-8779-01f5c619092e', 'business@test.com', 'business_demo', '\$2b\$10\$rGQHFh2Cv7hZZl7Zj7mZWu.VKVzRjZrKxXgO0lz5mJz8QHgxLpZUa', 'Business Demo User', 'business', true, NOW() - INTERVAL '60 days'),
('84a2713d-4a24-4bd6-bf01-ac0e7c3c007b', 'enterprise@test.com', 'enterprise_demo', '\$2b\$10\$rGQHFh2Cv7hZZl7Zj7mZWu.VKVzRjZrKxXgO0lz5mJz8QHgxLpZUa', 'Enterprise Demo User', 'enterprise', true, NOW() - INTERVAL '90 days')
ON CONFLICT (id) DO NOTHING;

-- Create default categories for demo users
SELECT create_default_categories('aabba4be-51cd-46cb-99cc-17211c62343a');
SELECT create_default_categories('6c744ef0-c664-454a-8779-01f5c619092e');
SELECT create_default_categories('84a2713d-4a24-4bd6-bf01-ac0e7c3c007b');
"
...
('qr-demo-001-analytics-website', 'aabba4be-51cd-46cb-99cc-17211c62343a', (SELECT id FROM qr_categories WHERE user_id = 'aabba4be-51cd-46cb-99cc-17211c62343a' AND name = 'Business' LIMIT 1), 'DEMO001', 'Company Website', 'url', '{\"url\": \"https://demo-company.com\"}', '{\"size\": 300, \"errorCorrectionLevel\": \"M\", \"foregroundColor\": \"#000000\", \"backgroundColor\": \"#ffffff\", \"pattern\": \"square\", \"margin\": 4}', 'https://demo-company.com', true, 1247, NOW() - INTERVAL '25 days'),
('qr-demo-002-product-catalog', 'aabba4be-51cd-46cb-99cc-17211c62343a', (SELECT id FROM qr_categories WHERE user_id = 'aabba4be-51cd-46cb-99cc-17211c62343a' AND name = 'Marketing' LIMIT 1), 'DEMO002', 'Product Catalog', 'url', '{\"url\": \"https://demo-company.com/products\"}', '{\"size\": 350, \"errorCorrectionLevel\": \"M\", \"foregroundColor\": \"#3B82F6\", \"backgroundColor\": \"#ffffff\", \"pattern\": \"rounded\", \"margin\": 4}', 'https://demo-company.com/products', true, 892, NOW() - INTERVAL '20 days'),
('qr-demo-003-contact-card', 'aabba4be-51cd-46cb-99cc-17211c62343a', (SELECT id FROM qr_categories WHERE user_id = 'aabba4be-51cd-46cb-99cc-17211c62343a' AND name = 'Business' LIMIT 1), 'DEMO003', 'Contact Card', 'vcard', '{\"firstName\": \"John\", \"lastName\": \"Doe\", \"email\": \"john@demo.com\", \"phone\": \"+1234567890\", \"company\": \"Demo Company\"}', '{\"size\": 300, \"errorCorrectionLevel\": \"H\", \"foregroundColor\": \"#059669\", \"backgroundColor\": \"#ffffff\", \"pattern\": \"dots\", \"margin\": 4}', null, true, 634, NOW() - INTERVAL '18 days'),
('qr-demo-004-event-ticket', 'aabba4be-51cd-46cb-99cc-17211c62343a', (SELECT id FROM qr_categories WHERE user_id = 'aabba4be-51cd-46cb-99cc-17211c62343a' AND name = 'Events' LIMIT 1), 'DEMO004', 'Conference 2024', 'text', '{\"text\": \"Conference 2024 - Ticket #12345\"}', '{\"size\": 200, \"errorCorrectionLevel\": \"H\", \"foregroundColor\": \"#7c3aed\", \"backgroundColor\": \"#ffffff\", \"pattern\": \"circle\", \"margin\": 4}', null, true, 1156, NOW() - INTERVAL '15 days'),
('qr-demo-005-wifi-access', 'aabba4be-51cd-46cb-99cc-17211c62343a', (SELECT id FROM qr_categories WHERE user_id = 'aabba4be-51cd-46cb-99cc-17211c62343a' AND name = 'General' LIMIT 1), 'DEMO005', 'Office WiFi', 'wifi', '{\"ssid\": \"DemoOffice\", \"password\": \"Demo123!\", \"security\": \"WPA\"}', '{\"size\": 250, \"errorCorrectionLevel\": \"M\", \"foregroundColor\": \"#dc2626\", \"backgroundColor\": \"#ffffff\", \"pattern\": \"square\", \"margin\": 4}', null, true, 423, NOW() - INTERVAL '12 days'),
-- Business Demo User QR Codes
('qr-demo-006-restaurant-menu', '6c744ef0-c664-454a-8779-01f5c619092e', (SELECT id FROM qr_categories WHERE user_id = '6c744ef0-c664-454a-8779-01f5c619092e' AND name = 'Business' LIMIT 1), 'DEMO006', 'Restaurant Menu', 'url', '{\"url\": \"https://restaurant-demo.com/menu\"}', '{\"size\": 400, \"errorCorrectionLevel\": \"M\", \"foregroundColor\": \"#f59e0b\", \"backgroundColor\": \"#ffffff\", \"pattern\": \"rounded\", \"margin\": 4}', 'https://restaurant-demo.com/menu', true, 2341, NOW() - INTERVAL '45 days'),
('qr-demo-007-social-media', '6c744ef0-c664-454a-8779-01f5c619092e', (SELECT id FROM qr_categories WHERE user_id = '6c744ef0-c664-454a-8779-01f5c619092e' AND name = 'Marketing' LIMIT 1), 'DEMO007', 'Social Media Links', 'url', '{\"url\": \"https://linktr.ee/restaurant-demo\"}', '{\"size\": 300, \"errorCorrectionLevel\": \"M\", \"foregroundColor\": \"#ec4899\", \"backgroundColor\": \"#ffffff\", \"pattern\": \"dots\", \"margin\": 4}', 'https://linktr.ee/restaurant-demo', true, 1567, NOW() - INTERVAL '35 days'),
('qr-demo-008-feedback-form', '6c744ef0-c664-454a-8779-01f5c619092e', (SELECT id FROM qr_categories WHERE user_id = '6c744ef0-c664-454a-8779-01f5c619092e' AND name = 'General' LIMIT 1), 'DEMO008', 'Customer Feedback', 'url', '{\"url\": \"https://forms.google.com/feedback-demo\"}', '{\"size\": 250, \"errorCorrectionLevel\": \"M\", \"foregroundColor\": \"#10b981\", \"backgroundColor\": \"#ffffff\", \"pattern\": \"square\", \"margin\": 4}', 'https://forms.google.com/feedback-demo', true, 789, NOW() - INTERVAL '28 days'),
-- Enterprise Demo User QR Codes
('qr-demo-009-employee-badge', '84a2713d-4a24-4bd6-bf01-ac0e7c3c007b', (SELECT id FROM qr_categories WHERE user_id = '84a2713d-4a24-4bd6-bf01-ac0e7c3c007b' AND name = 'Business' LIMIT 1), 'DEMO009', 'Employee Badge', 'vcard', '{\"firstName\": \"Jane\", \"lastName\": \"Smith\", \"email\": \"jane@enterprise-demo.com\", \"phone\": \"+9876543210\", \"company\": \"Enterprise Demo Corp\", \"title\": \"Senior Manager\"}', '{\"size\": 200, \"errorCorrectionLevel\": \"H\", \"foregroundColor\": \"#1f2937\", \"backgroundColor\": \"#ffffff\", \"pattern\": \"rounded\", \"margin\": 4}', null, true, 345, NOW() - INTERVAL '70 days'),
('qr-demo-010-asset-tracking', '84a2713d-4a24-4bd6-bf01-ac0e7c3c007b', (SELECT id FROM qr_categories WHERE user_id = '84a2713d-4a24-4bd6-bf01-ac0e7c3c007b' AND name = 'General' LIMIT 1), 'DEMO010', 'Asset #A1234', 'text', '{\"text\": \"Asset ID: A1234\\nLocation: Building B, Floor 3\\nPurchased: 2023-01-15\"}', '{\"size\": 150, \"errorCorrectionLevel\": \"H\", \"foregroundColor\": \"#374151\", \"backgroundColor\": \"#ffffff\", \"pattern\": \"square\", \"margin\": 2}', null, true, 156, NOW() - INTERVAL '65 days')
ON CONFLICT (id) DO NOTHING;
"
...
echo -e "  📧 pro@test.com (Pro user with 5 QR codes)"
echo -e "  📧 business@test.com (Business user with 3 QR codes)"  
echo -e "  📧 enterprise@test.com (Enterprise user with 2 QR codes)"
echo ""
